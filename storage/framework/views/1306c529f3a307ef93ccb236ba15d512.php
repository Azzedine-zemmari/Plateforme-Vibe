...
<?php endif; ?>
        ...
        <div class="mt-6">
            ...
            <div class="flex justify-center space-x-4">
                ...
                <a href="<?php echo e(route('auth.facebook')); ?>" class="flex items-center justify-center bg-white hover:bg-gray-100 border border-gray-300 rounded-lg p-2 shadow-sm transition duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
<?php endif; ?><?php /**PATH C:\Users\safiy\Desktop\vb\Plateforme-Vibe-main\resources\views/auth/login.blade.php ENDPATH**/ ?>