...
<?php $component->withAttributes([]); ?>
    <?php if(session('success')): ?>
        ...
        <img class="w-5" src="<?php echo e(asset('/images/success-filled-svgrepo-com.svg')); ?>" />
    ...
    <?php if(session('error')): ?>
        <div id='sessiont' class="flex items-center space-x-3 bg-[#f8d7da] text-[#721c24] p-4 border border-[#f5c6cb] rounded-md mb-7 shadow-md">
            <img class="w-5" src="<?php echo e(asset('/images/error-filled-svgrepo-com.svg')); ?>" />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500"><?php echo e(count($freinds)); ?> friends</p>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <a  href="<?php echo e(route('users')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $freinds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $freind): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="p-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <div class="h-16 w-16 rounded-full bg-indigo-100 flex items-center justify-center overflow-hidden border-2 border-indigo-200">
                                <img 
                                    src="<?php echo e(asset('/storage/'. $freind->image)); ?>" 
                                    alt="<?php echo e($freind->name); ?>'s profile" 
                        ...
                        <!-- User Info -->
                        <div class="flex-1">
                            <a  href="<?php echo e(url('/USERPROFILE/'. $freind->id)); ?>"  class="text-lg font-semibold text-gray-900"><?php echo e($freind->name); ?></a>
                            <p class="text-sm text-gray-500"><?php echo e($freind->pseudo ?? ''); ?></p>
                            <p class="text-sm text-gray-500 truncate"><?php echo e($freind->email); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 flex justify-between items-center pt-4 border-t border-gray-200">
                        <button class="inline-flex items-center text-sm text-gray-500 hover:text-indigo-600">
                            ...
                            <p><?php echo e($freind->status); ?></p>
                        </button>
                        <form action="/accepteRequest" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="freindId" value="<?php echo e($freind->id); ?>">
...
<?php endif; ?><?php /**PATH C:\Users\safiy\Desktop\vb\Plateforme-Vibe-main\resources\views/users/Myfreinds.blade.php ENDPATH**/ ?>